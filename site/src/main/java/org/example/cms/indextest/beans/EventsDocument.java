...
@HippoEssentialsGenerated(internalName = "myindextestproject:eventsdocument")
@Node(jcrType="myindextestproject:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "myindextestproject:eventsdocument";
    ...
    private final static String END_DATE = "myindextestproject:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "myindextestproject:enddate")
